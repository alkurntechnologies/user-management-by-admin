                        ...
                        @foreach($result as $row)
                            <tr>
                                ...
                                <td class="text-center" style="white-space:nowrap;">
                                    <a href="{{URL::to('/admin/edit-blog',['id'=>@$row->id])}}" title="Edit"><i class="fa fa-edit fa-fw fa-lg"></i></a>
                                    
                                    <a href="javascript:void(0);" class="deleteBlog" id="{{@$row->id}}" title="Delete"><i class="fa fa-trash fa-fw fa-lg"></i></a>
...
<script type="text/javascript">
    $(document).ready(function () {
            ...
            $("#example1").on("click", ".deleteBlog", function (e) {
    ...
    $(document).on("click", ".activate", function (e) {
        ...
        $.ajax({
            type: "post",
            url: "{{ url('/admin/activate-deactivate-blog') }}",
            data: {
                "_token": "{{ csrf_token() }}",
                "id": id,
                "status": status
