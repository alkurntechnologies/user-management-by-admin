...
@section('page_title')
{{config('app.name')}} | Manage Customers
@endsection
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{Request::root()}}/admin/add-customer" class="btn btn-success btn-gold-styled pull-right"><i class="fa fa-plus"></i> Add Customer</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                ...
                <div class="table-responsive">
                    <table class="table" id="example1">
                        ...
                        <tr>
                            ...
                            <th class="column-title">Email Verified</th>
                        ...
                        @foreach($result as $row)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{URL::to('/admin/edit-customer',['id'=>@$row->id])}}" title="Edit"><i class="fa fa-edit fa-fw fa-lg"></i></a>
