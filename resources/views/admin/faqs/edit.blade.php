                    ...
                    <fieldset>
                        <div class="form-group">
                            ...
                            <select name="topic_id" id="topic_id" class="form-control" required=""data-parsley-required-message="Please select topic.">
                                ...
                                <option value="{{$topic->id}}" @if($topic->id==@$row->topic_id) selected @endif>{{$topic->topic}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail4">Question</label>
                            <input type="text" class="form-control" name="question"
                                    id="question" placeholder="Enter question" required=""  data-parsley-required-message="Please enter question." value="{{@$row->question}}">
                        ...
                        <div class="form-group ns-des show-maze-images">
                            <label for="exampleInputEmail4">Answer</label> 
                            <textarea name="answer" id="answer" placeholder="Enter answer" class="form-control" required="" data-parsley-required-message="Please enter answer." data-parsley-errors-container="#descriptionError">{!! @$row->answer !!}</textarea>
