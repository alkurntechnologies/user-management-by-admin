                ...
                <form action="" method="post"
                    ...
                    <fieldset>
                        ...
                        <div class="form-group ns-des show-maze-icons">
                            ...
                            <textarea name="content" id="content" placeholder="Enter content" class="form-control" required="" data-parsley-required-message="Please enter content." data-parsley-errors-container="#contentError">{{@$row->content}}</textarea>
                        ...
                        <div class="form-group">
                            <label class="d-block" for="exampleInputEmail4">Banner</label>
                            @if(@$row->banner!='')<img src="{{url('storage/app').'/'.@$row->banner}}" height="100" width="150">@endif

                            <label class="d-block" for="exampleInputEmail4">Update Banner</label>
                            <input type="file" class="form-control img-upload-tag" name="banner"
                                    id="banner" data-parsley-required-message="Please upload banner." data-parsley-fileextension="jpg,jpeg,png,JPG,JPEG,PNG">
                        ...
                        <!-- <div class="form-group">
                            ...
                            <select multiple="" name="position[]" id="position" class="form-control" required=""  data-parsley-required-message="Please select position."  data-parsley-errors-container="#statusError">
                                @php $position = explode(',',@$row->position); @endphp
                                <option value="header" @if(in_array('header',$position)) selected @endif>Header</option>
                                <option value="footer" @if(in_array('footer',$position)) selected @endif>Footer</option>
                            </select>
